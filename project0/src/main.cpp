...
const int LAYOUT = 0;
const wchar_t* APP_TITLE = L"任务0：考勤管理系统";
const wchar_t* REQUIREMENT_TEXT = L"输入、输出、修改、删除学生缺课信息。";
const wchar_t* SPECIAL_LABEL = L"缺课统计";
const wchar_t* INPUT_HINT = L"请输入：缺课日期,课程名称,学生姓名,学生学号,缺课类型\n例如：2026-06-15,C++程序设计,张三,20240101,迟到";
const wchar_t* DEFAULT_STATUS = L"有效";
const wchar_t* STYLE_NAME = L"校园考勤蓝白表格风";
const std::vector<std::wstring> FIELD_NAMES = { L"缺课日期", L"课程名称", L"学生姓名", L"学生学号", L"缺课类型" };

const COLORREF BG_COLOR = RGB(244, 248, 253);
const COLORREF HEADER_COLOR = RGB(25, 84, 154);
const COLORREF ACCENT_COLOR = RGB(32, 118, 207);
const COLORREF PANEL_COLOR = RGB(255, 255, 255);
const COLORREF ROW_COLOR = RGB(255, 255, 255);
const COLORREF SELECTED_COLOR = RGB(218, 235, 255);
const COLORREF LINE_COLOR = RGB(202, 218, 238);
const COLORREF TITLE_COLOR = RGB(23, 55, 102);
const COLORREF TEXT_COLOR = RGB(35, 47, 65);
const COLORREF SUBTEXT_COLOR = RGB(88, 105, 130);
...
static std::vector<Record> seedRecords() {
    return { Record{1001, { L"2026-06-01", L"C++程序设计", L"张三", L"20240101", L"迟到" }, L"有效"}, Record{1002, { L"2026-06-03", L"数据结构", L"李四", L"20240102", L"请假" }, L"有效"} };
}
