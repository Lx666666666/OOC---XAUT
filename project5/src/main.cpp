...
const int PROJECT_ID = 5;
const int LAYOUT = 1;
const wchar_t* APP_TITLE = L"任务5：电话号码簿管理系统";
const wchar_t* REQUIREMENT_TEXT = L"输入、输出、修改、删除联系人信息。";
const wchar_t* SPECIAL_LABEL = L"查看详情";
const wchar_t* INPUT_HINT = L"请输入：联系人姓名,电话号码,单位,邮箱,备注\n例如：张三,13800000000,学生会,zhang@example.com,同学";
const wchar_t* DEFAULT_STATUS = L"正常";
const wchar_t* STYLE_NAME = L"通讯录便签风";
const std::vector<std::wstring> FIELD_NAMES = { L"联系人姓名", L"电话号码", L"单位", L"邮箱", L"备注" };

const COLORREF BG_COLOR = RGB(255, 250, 238);
const COLORREF HEADER_COLOR = RGB(169, 103, 44);
const COLORREF ACCENT_COLOR = RGB(217, 130, 57);
const COLORREF PANEL_COLOR = RGB(255, 255, 250);
const COLORREF ROW_COLOR = RGB(255, 252, 241);
const COLORREF SELECTED_COLOR = RGB(255, 232, 190);
const COLORREF LINE_COLOR = RGB(232, 207, 170);
const COLORREF TITLE_COLOR = RGB(124, 75, 35);
const COLORREF TEXT_COLOR = RGB(65, 50, 36);
const COLORREF SUBTEXT_COLOR = RGB(126, 104, 76);
...
static std::vector<Record> seedRecords() {
    return { Record{1001, { L"张三", L"13800000000", L"学生会", L"zhang@example.com", L"同学" }, L"正常"}, Record{1002, { L"李四", L"13900000000", L"实验室", L"li@example.com", L"组员" }, L"正常"} };
}
