...
const int LAYOUT = 1;
const wchar_t* APP_TITLE = L"任务1：医院管理系统";
const wchar_t* REQUIREMENT_TEXT = L"输入病人、输出病人信息、修改病人信息、办理病人出院。";
const wchar_t* SPECIAL_LABEL = L"病人出院";
const wchar_t* INPUT_HINT = L"请输入：病人姓名,病人类型,主治大夫,科室,入院日期\n例如：王五,住院,刘医生,内科,2026-06-15";
const wchar_t* DEFAULT_STATUS = L"治疗中";
const wchar_t* STYLE_NAME = L"医院绿白侧栏风";
const std::vector<std::wstring> FIELD_NAMES = { L"病人姓名", L"病人类型", L"主治大夫", L"科室", L"入院日期" };

const COLORREF BG_COLOR = RGB(241, 249, 246);
const COLORREF HEADER_COLOR = RGB(20, 126, 103);
const COLORREF ACCENT_COLOR = RGB(31, 151, 121);
const COLORREF PANEL_COLOR = RGB(255, 255, 255);
const COLORREF ROW_COLOR = RGB(249, 255, 252);
const COLORREF SELECTED_COLOR = RGB(206, 244, 229);
const COLORREF LINE_COLOR = RGB(192, 224, 214);
const COLORREF TITLE_COLOR = RGB(19, 94, 79);
const COLORREF TEXT_COLOR = RGB(31, 55, 50);
const COLORREF SUBTEXT_COLOR = RGB(89, 120, 112);
...
static std::vector<Record> seedRecords() {
    return { Record{1001, { L"王五", L"住院", L"刘医生", L"内科", L"2026-06-10" }, L"治疗中"}, Record{1002, { L"赵六", L"门诊", L"陈医生", L"外科", L"2026-06-12" }, L"治疗中"} };
}
