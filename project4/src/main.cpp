...
const int PROJECT_ID = 4;
const int LAYOUT = 4;
const wchar_t* APP_TITLE = L"任务4：选课管理信息系统";
const wchar_t* REQUIREMENT_TEXT = L"输入、输出、修改、删除学生选课信息。";
const wchar_t* SPECIAL_LABEL = L"选课统计";
const wchar_t* INPUT_HINT = L"请输入：学生姓名,学生学号,课程名称,任课教师,学分\n例如：张三,20240101,C++程序设计,王老师,3";
const wchar_t* DEFAULT_STATUS = L"已选课";
const wchar_t* STYLE_NAME = L"教务卡片风";
const std::vector<std::wstring> FIELD_NAMES = { L"学生姓名", L"学生学号", L"课程名称", L"任课教师", L"学分" };

const COLORREF BG_COLOR = RGB(246, 246, 252);
const COLORREF HEADER_COLOR = RGB(72, 84, 145);
const COLORREF ACCENT_COLOR = RGB(215, 95, 75);
const COLORREF PANEL_COLOR = RGB(255, 255, 255);
const COLORREF ROW_COLOR = RGB(255, 255, 255);
const COLORREF SELECTED_COLOR = RGB(236, 232, 255);
const COLORREF LINE_COLOR = RGB(214, 215, 231);
const COLORREF TITLE_COLOR = RGB(55, 64, 119);
const COLORREF TEXT_COLOR = RGB(42, 45, 66);
const COLORREF SUBTEXT_COLOR = RGB(96, 98, 125);
...
static std::vector<Record> seedRecords() {
    return { Record{1001, { L"张三", L"20240101", L"C++程序设计", L"王老师", L"3" }, L"已选课"}, Record{1002, { L"李四", L"20240102", L"数据结构", L"赵老师", L"4" }, L"已选课"} };
}
