...
const int LAYOUT = 2;
const wchar_t* APP_TITLE = L"任务2：网吧管理系统";
const wchar_t* REQUIREMENT_TEXT = L"输入顾客、输出顾客信息、修改顾客信息、按会员类型和上机时间结账。";
const wchar_t* SPECIAL_LABEL = L"顾客结账";
const wchar_t* INPUT_HINT = L"请输入：顾客姓名,顾客类型,机器号,上机小时\n例如：张三,会员,12,3.5";
const wchar_t* DEFAULT_STATUS = L"上机中";
const wchar_t* STYLE_NAME = L"网吧深色霓虹风";
const std::vector<std::wstring> FIELD_NAMES = { L"顾客姓名", L"顾客类型", L"机器号", L"上机小时" };

const COLORREF BG_COLOR = RGB(17, 22, 33);
const COLORREF HEADER_COLOR = RGB(34, 43, 68);
const COLORREF ACCENT_COLOR = RGB(37, 204, 177);
const COLORREF PANEL_COLOR = RGB(28, 36, 54);
const COLORREF ROW_COLOR = RGB(35, 45, 66);
const COLORREF SELECTED_COLOR = RGB(45, 82, 102);
const COLORREF LINE_COLOR = RGB(67, 86, 118);
const COLORREF TITLE_COLOR = RGB(216, 244, 242);
const COLORREF TEXT_COLOR = RGB(229, 237, 245);
const COLORREF SUBTEXT_COLOR = RGB(163, 181, 201);
...
static std::vector<Record> seedRecords() {
    return { Record{1001, { L"张三", L"会员", L"12", L"3.5" }, L"上机中"}, Record{1002, { L"李四", L"非会员", L"18", L"2" }, L"上机中"} };
}
