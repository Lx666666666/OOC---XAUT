...
const int LAYOUT = 3;
const wchar_t* APP_TITLE = L"任务3：水电煤气管理系统";
const wchar_t* REQUIREMENT_TEXT = L"录入用户水电煤气数据、输出用户信息、修改用户信息、计算应缴费用。";
const wchar_t* SPECIAL_LABEL = L"计算费用";
const wchar_t* INPUT_HINT = L"请输入：用户姓名,用户编号,用水量,用电量,用气量\n例如：张三,U001,12,80,20";
const wchar_t* DEFAULT_STATUS = L"未缴费";
const wchar_t* STYLE_NAME = L"能源缴费仪表盘风";
const std::vector<std::wstring> FIELD_NAMES = { L"用户姓名", L"用户编号", L"用水量", L"用电量", L"用气量" };

const COLORREF BG_COLOR = RGB(250, 247, 240);
const COLORREF HEADER_COLOR = RGB(111, 86, 54);
const COLORREF ACCENT_COLOR = RGB(23, 132, 123);
const COLORREF PANEL_COLOR = RGB(255, 252, 246);
const COLORREF ROW_COLOR = RGB(255, 255, 255);
const COLORREF SELECTED_COLOR = RGB(224, 245, 241);
const COLORREF LINE_COLOR = RGB(224, 214, 199);
const COLORREF TITLE_COLOR = RGB(79, 63, 43);
const COLORREF TEXT_COLOR = RGB(48, 43, 37);
const COLORREF SUBTEXT_COLOR = RGB(111, 101, 86);
...
static std::vector<Record> seedRecords() {
    return { Record{1001, { L"张三", L"U001", L"12", L"80", L"20" }, L"未缴费"}, Record{1002, { L"李四", L"U002", L"8", L"65", L"15" }, L"未缴费"} };
}
